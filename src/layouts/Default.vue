  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-teal-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" class="uppercase tracking-wide font-bold text-copy-primary hover:text-gray-600" to="/">Code and Cricket</g-link>
          <g-link v-else  class="no-underline uppercase tracking-wide font-bold text-copy-primary hover:text-gray-600" to="/">Code and Cricket</g-link>
        </div>
